...
class StringEmbedCNN(nn.Module):
    ...
    def __init__(self, field_config, embedding_size):
        ...
        # n_convs is solution of (max_str_len / 2 ** n_convs = 4) for n_convs
        # use "x / (2 ^ c) = 4 solve c" on https://www.wolframalpha.com/
        n_convs = max(math.ceil((math.log(self.max_str_len) / math.log(2)) - 2), 1)
        convs = []
        for i in range(n_convs):
            ...
            convs.append(nn.AvgPool1d(kernel_size=2))
